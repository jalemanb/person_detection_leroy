...
from .utils import kp_img_to_kp_bbox, rescale_keypoints, iou_vectorized, bbox_to_xyah, xyah_to_bbox
...
class SOD:
    ...
    def __init__(self, yolo_model_path, feature_extracture_model_path, feature_extracture_cfg_path, tracker_system_path = "") -> None:
        ...
        # ReID System
        self.kpr_reid = KPR(feature_extracture_cfg_path, feature_extracture_model_path, kpt_conf=0.8, device='cuda' if torch.cuda.is_available() else 'cpu')
    ...
    def detect(self, img_rgb, img_depth, camera_params = [1., 1., 1., 1.], detection_class=0):
